				...
				<ul className=" mt-8 flex flex-col p-2  text-white ">
						...
						>
							...
							<h1 className="flex  text-center text-xl mb-10">
									<span ><AiOutlineHome size={28} className=" pr-2" /></span>Feed</h1>
							</NavLink>
								<NavLink
									to="/notifications"
						>
							...
							<h1 className="flex  text-center text-xl mb-10">
									<span ><AiOutlineBell size={28} className=" pr-2" /></span>Notifications</h1>
						</NavLink>
						...
						>
							...
							<h1 className="flex  text-center text-xl mb-10">
									<span ><AiOutlineUser size={28} className=" pr-2" /></span>Profile</h1>
							</NavLink>
								</li>
